...
OPTIONS+=" no-ec no-ec2m no-engine no-hw no-filenames no-err"
OPTIONS+=" no-bf no-blake2 no-camellia no-cast no-chacha no-cmac no-des no-ecdh no-ecdsa no-idea no-md4 no-mdc2 no-ocb no-poly1305 no-rc2 no-rc4 no-rmd160 no-scrpyt no-seed no-siphash no-sm3 no-sm4 no-whirlpool"
